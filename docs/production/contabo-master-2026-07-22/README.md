...
> **Release update 2 (2026-07-23 night AEST):** `vps-testmating-identity-r5`, `vps-pedigree-polish-r6` and `vps-bloodline-tree-r7` are live in sequence — dog identity bridging (search dedupe, bridged pedigrees/stats, hist_dog id fix), Test Mating gated under the $20 Pro plan, and the interactive bloodline tree (measured SVG branches, mobile drill-down focus, no horizontal scrolling). DB/perf/security audit in progress and GRV FastTrack assessed (ToS-blocked; written-consent/Topaz path drafted). See [evidence/2026-07-23-session/db-security-audit-2026-07-23.md](./evidence/2026-07-23-session/db-security-audit-2026-07-23.md) and [evidence/2026-07-23-session/grv-data-request-draft.md](./evidence/2026-07-23-session/grv-data-request-draft.md).
