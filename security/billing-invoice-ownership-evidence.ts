...
export const BILLING_INVOICE_OWNERSHIP_BOUNDARY = {
  ...
  privilegedScope:
    "The same runtime proof confirms that the source-defined moderator and system contexts retain the intentional cross-user billing visibility granted by policy.",
  deployedScope:
