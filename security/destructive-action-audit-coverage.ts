...
export const PRODUCTION_DESTRUCTIVE_ACTION_CLASSIFICATIONS = [
  ...
  {
    actionId: "src/lib/friend-service.ts:350:friendship.delete",
    disposition: "audit-required",
    auditEventId: "AUDIT.FRIENDSHIP.MUTATION",
