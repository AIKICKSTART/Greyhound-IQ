  ...
  return (
    <div>
      ...
      <section className="mx-auto max-w-3xl px-6 py-16">
        <h2
          className="text-2xl font-semibold text-[hsl(var(--foreground))] mb-4 tracking-[-0.03em]"
        >
          Why we built it
        </h2>
        <div
      ...
      <section className="mx-auto max-w-6xl px-6 py-12">
        <h2
          className="text-2xl font-semibold text-[hsl(var(--foreground))] mb-8 tracking-[-0.03em]"
        >
          What we believe
        </h2>
          ...
          {VALUES.map((v) => {
            ...
            return (
              ...
              >
                ...
                <h3
                  className="text-[16px] font-semibold text-[hsl(var(--foreground))] mb-2 tracking-[-0.02em]"
                >
                  {v.title}
                </h3>
                <p
      ...
      <section className="mx-auto max-w-3xl px-6 py-12 text-center">
        ...
        <p
          className="text-[15px] text-[hsl(var(--muted-foreground))] mb-6 tracking-[-0.011em]"
        >
