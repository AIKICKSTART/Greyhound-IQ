    ...
    <div>
      ...
      <section className="mx-auto max-w-6xl px-6 py-16">
        ...
        <p className="text-[14px] text-[hsl(var(--muted-foreground))] mb-8 tracking-[-0.013em]">
          Deeper pedigree and testmating tools are coming after the MVP.
        </p>
      ...
      <section className="mx-auto max-w-3xl px-6 pb-20 text-center">
        ...
        <p className="text-[14px] text-[hsl(var(--muted-foreground))] leading-relaxed max-w-xl mx-auto tracking-[-0.013em]">
          Live sire leaders are free. Pedigrees, testmating, and litter tools
          follow as the breeding dataset matures.
        </p>
      </section>
    </div>
  );
