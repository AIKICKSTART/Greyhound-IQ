      ...
      <ControlGroup label="Search locations" htmlFor="vet-search">
        <div className="giq-vet-field relative flex h-12 items-center overflow-hidden">
          ...
          <input
            ...
            autoComplete="off"
            spellCheck={false}
            className="h-full w-full min-w-0 border-0 bg-transparent pl-11 pr-3 text-[14px] text-[hsl(var(--foreground))] outline-none placeholder:text-[hsl(var(--muted-foreground))] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[hsl(var(--primary-bright))]"
          />
  ...
  return (
    <div className={`giq-vet-field relative flex items-center overflow-hidden ${className}`}>
      <select
        ...
        className="h-full w-full min-w-0 appearance-none border-0 bg-transparent pl-3.5 pr-9 text-[13px] text-[hsl(var(--foreground))] outline-none focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[hsl(var(--primary-bright))]"
      >
        {children}
      </select>
      <ChevronDown
